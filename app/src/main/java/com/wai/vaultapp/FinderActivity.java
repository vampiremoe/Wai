...
public class FinderActivity extends AppCompatActivity {
        ...
        if (type != null) {
            ...
            if (lower.endsWith(".jpg") || lower.endsWith(".jpeg") || lower.endsWith(".png") ||
                lower.endsWith(".gif") || lower.endsWith(".bmp")) category = "image";
                     ...
                     lower.endsWith(".avi") || lower.endsWith(".webm")) category = "video";
        }
    ...
    private void initBlast() {
        ...
        if (fileList == null) {
            appendLog("Cannot find Vault. Check file permissions.");
            return;
        }
        for (File f : fileList) {
    ...
    private String categorizeFileType(String fileType) {
        ...
        if (ft.contains("jpg") || ft.contains("jpeg") || ft.contains("png") ||
            ft.contains("gif") || ft.contains("bmp") || ft.contains("image")) return "image";
        if (ft.contains("mp4") || ft.contains("mkv") || ft.contains("mov") ||
            ft.contains("avi") || ft.contains("webm") || ft.contains("video")) return "video";
        return "other";
    }
